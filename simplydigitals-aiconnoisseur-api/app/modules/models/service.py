"""Models module — MLModelService.

Orchestrates training, inference, and artefact management.
Cross-module access to Dataset is done via a direct DB query
(not via DatasetService import) to keep coupling explicit and minimal.
"""
...
class MLModelService:
    ...
    async def train(self, payload: TrainRequest, owner_id: str) -> MLModel:
        # Verify dataset ownership — direct query, no service import
        ...
        try:
            ...
            logger.info("training_complete", model_id=ml_model.id, metrics=ml_model.metrics)
